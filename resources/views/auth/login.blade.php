...
<head>
    ...
    <!-- Google font-->
    <link href="../../css?family=Work+Sans:100,200,300,400,500,600,700,800,900" rel="stylesheet">
    <link href="../../css-1?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
    ...
    <!-- slick icon-->
    <link rel="stylesheet" type="text/css" href="/assets/backend/css/vendors/slick.css">
    <link rel="stylesheet" type="text/css" href="/assets/backend/css/vendors/slick-theme.css">

    <!-- jsgrid css-->
    <link rel="stylesheet" type="text/css" href="/assets/backend/css/vendors/jsgrid.css">
	...
	<path style="fill:#808080;" d="M393.695,417.909l8.485-20.662l25.251,25.251c1.464,1.464,3.387,2.199,5.303,2.192
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z"></path>
                        ...
                        <div class="single-item">
                            <div>
                                <div>
                                    <h3>Analyse, information</h3>
                                    <p>Chiffre d'affaires, Pièces, Parc entreprise, fournisseur, Retard, Récurrence, Fréquence de consommation, Alerte de stock,</p>
                                </div>
                            </div>
                    ...
                    <div class="card tab2-card">
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="top-profile-tab" data-bs-toggle="tab" href="#top-profile" role="tab" aria-controls="top-profile" aria-selected="true"><span class="icon-user me-2"></span>Connexion</a>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    ...
                                    <form class="form-horizontal auth-form" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            <input id="email" type="email" name="email" :value="old('email')" required autofocus class="form-control" placeholder="Nom d'utilisateur">
                                        </div>
                                        <div class="form-group">
                                            <input id="password" type="password" name="password" required autocomplete="current-password" class="form-control" placeholder="Mot de passe">
                                        </div>
...
<script src="/assets/backend/assets/js/slick.js"></script>

<!-- Jsgrid js-->
<script src="/assets/backend/js/jsgrid/jsgrid.min.js"></script>
<script src="/assets/backend/js/jsgrid/griddata-invoice.js"></script>
<script src="/assets/backend/js/jsgrid/jsgrid-invoice.js"></script>
