                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="page-header-left">
                                <h3>Ajouter le CA d'une entreprise
                        ...
                        <div class="col-lg-6">
                            <ol class="breadcrumb pull-right">
                                ...
                                <li class="breadcrumb-item">Chiffre d'affaires d'une entreprise</li>
                ...
                <div class="row">
                        <div class="card">
                            <div class="card-header">
                                <h5>Ajouter le chiffre d'affaire d'une entreprise</h5>
                            </div>
                            <div class="card-body">
                                <div class="row product-adding">
									...
									@endif
									<form class="needs-validation add-product-form" method="POST" action="{{route('turnovercompany.store')}}" >
                                            @csrf
									<div class="row">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="form">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col-xl-8 col-sm-7">
                                                        <input type="number" step="0.01" min="0" name="sales_amount" id="sales_amount" class="form-control" required>
                                                    </div>
                                                    <div class="valid-feedback">Looks good!</div>
                                                </div>
                                                <div class="form-group mb-3 row">
									...
									<div class="col-xl-6">
											...
											<div class="form">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col-xl-8 col-sm-7">
                                                        <input type="number" step="0.01" min="0"  name="quotes_amount" id="quotes_amount" class="form-control" required>
                                                    </div>
                                                    <div class="valid-feedback">Looks good!</div>
                                            ...
                                            <div class="form">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col-xl-8 col-sm-7">
                                                        <input type="number" step="0.01" min="0"  name="quotes" id="quotes" class="form-control" required>
                                                    </div>
                                                    <div class="valid-feedback">Looks good!</div>
                                            ...
                                            <div class="form">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col-xl-8 col-sm-7">
                                                        <input type="number" step="0.01" min="0"  name="sales" id="sales" class="form-control" required>
                                                    </div>
                                                    <div class="valid-feedback">Looks good!</div>
