@extends('layouts.app')
@section('title', __('Liste Entrée/Sortie'))
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <ol class="breadcrumb pull-right">
                                ...
                                <li class="breadcrumb-item">Liste Entrée/Sortie</li>
            ...
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="btn-popup pull-right">
                            <a href="{{route('store.create')}}"><button type="button" class="btn btn-primary">Ajouter une entrée/sortie</button></a>
                    </div>
                    @endif
                        <table class="display" id="basic-1">
							...
							@foreach($stores as $store)
								<tr>
									...
									<td>{{$store->brand}}</td>
									<td>{{$store->quantity_in}}</td>
									<td>{{$store->price_in}}</td>
									<td>
										@forelse($providers as $provider)
											@if($provider->id==$store->provider_id)
											{{$provider->name}}
											@endif
										@empty
										@endforelse
									...
									<td>
										...
										<a href="{{route('store.edit',$store->id)}}"><i class="fa fa-edit me-2 font-success"></i></a>
										  ...
										  <a href="{{ route('store.destroy',['store' => $store->id]) }}" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModal{{$store->id}}"><i class="fa fa-trash font-danger"></i></a>
